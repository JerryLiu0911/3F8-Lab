...
alpha = 1 # XXX Learning rate for gradient-based optimisation. To be completed by the student
...
l = [0.01, 0.1, 1]# XXX Width of the Gaussian basis funcction. To be completed by the student
